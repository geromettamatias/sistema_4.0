...
$consulta = "SELECT `idAlumnos`, `nombreAlumnos`, `dniAlumnos`, `cuilAlumnos`, `domicilioAlumnos`, `emailAlumnos`, `telefonoAlumnos`, `discapasidadAlumnos`, `nombreTutor`, `dniTutor`, `TelefonoTutor`, `idPlanEstudio`, `fechaNa`, `nLegajos`, `nacido`, `procedencia`, `nacionalidadTutor`, `pass`, `estado` FROM `datosalumnos` WHERE `dniAlumnos`='$dni'";
...
if($resultado->rowCount() >= 1){
    $data = $resultado->fetchAll(PDO::FETCH_ASSOC);
     ...
     foreach($data as $dat1) {                                                        
         ...
         $pass_AL=base64_decode ($dat1['pass']);
...
<h2>AUTOGESTIÓN GENERADO // RECUPERAR USUARIO Y CONTRASEÑA</h2>
 ...
 <p><b>USUARIO: </b>'.$dni.'<br><b>CONTRASELA: </b>'.$pass_AL.'<br></p>
</body>
</html>
