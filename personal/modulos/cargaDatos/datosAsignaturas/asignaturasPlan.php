...
<?php
        ...
        if ($planSele!=1){
            $consulta = "SELECT `idAsig`, `idPlan`, `nombre`, `ciclo`, `cantidadHoraCatedra` FROM `plan_datos_asignaturas` WHERE `idPlan`='$planSele'";
          ...
          <div class="col-md-12">
            ...
            <div class="card card-success">
              ...
              <div class="card-header">
                <h3 class="card-title">Tabla de Asignatura del Plan de Estudio</h3>
              ...
              <div class="card-body">
                <div class="chart">
                          ...
                          <div id="cargaCicloSegundo"><img  src="../elementos/cargando.gif"  style="width: 150px;"></div>
...
function remover () {
    ...
    $('#planSele').val('Seleccione un Plan');
