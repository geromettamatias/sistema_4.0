...
$consulta = "SELECT `idDescrip`, `idAsignatura`, `dia`, `horario`, `corresponde`, `curso`, `idCurso` FROM `descripasig_$cicloLectivoFINAL` WHERE `idAsignatura`='$idAsignatura' AND `idCurso` ='$idCurso' ORDER BY `dia`, `horario`";
$resultado = $conexion->prepare($consulta);
$resultado->execute();
