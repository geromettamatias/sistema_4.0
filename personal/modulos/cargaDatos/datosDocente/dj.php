            ...
            <div class="card card-success">
              ...
              <div class="card-body">
                <div class="chart">
                    ...
                    <button  class="btn btn-danger glyphicon glyphicon-pencil" onclick="regresarBotonDocente('')">Regresar Tabla Docente</button>
...
$('#inf').html('');
  ...
  $("#cargoF").change(function(){
    cargoF= $('#cargoF').val();
  
    
    if (cargoF!='SELECCIONE UN CARGO') {
$('#imagenProceso').show();
     ...
     $.ajax({
          ...
          url:'modulos/cargaDatos/datosDocente/elementos/comprobarCargo.php',
          success:function(r){
...
function  eliminarAntesPlanDocenteAsigProyectoFF(id_asig_proyecto,opcion){
        ...
        $.ajax({
            url: "modulos/cargaDatos/datosDocente/elementos/crud_altaBajaAsignacion_proyecto.php",
            type: "POST",
            dataType: "json",
...
function  eliminarAntesPlanDocenteAsigCargoFF(id_asig_cargo,opcion){
        ...
        $.ajax({
            url: "modulos/cargaDatos/datosDocente/elementos/crud_altaBajaAsignacion_cargo.php",
            type: "POST",
            dataType: "json",
...
if (desde=='' || hasta=='') {
      ...
      opcion=4;
                  ...
                  $.ajax({
                      ...
                      url:'modulos/cargaDatos/datosDocente/elementos/crud_altaBajaAsignacion.php',
...
$("#btn_nuevo_dia_hora").click(function(){
  ...
  $('#asig').load('modulos/cargaDatos/datosDocente/elementos/cursoA.php');
...
$("#cus").change(function(){
  ...
  $.ajax({
          type:"post",
          data:'curso=' + curso + '&idAsig=' + idAsig,
          url:'modulos/cargaDatos/datosDocente/elementos/informacionAsignacion.php',         
          success:function(r){
...
$("#curso").change(function(){
      ...
      if (curso==0) {
       ...
       $.ajax({
          type:"post",
          data:'curso=' + curso,
          url:'modulos/cargaDatos/datosDocente/elementos/sessi2.php',
         
          success:function(r){

         
          
           $('#cus').load('modulos/cargaDatos/datosDocente/elementos/curso.php');
...
var tablaDocente_Asig_Proyecto = $('#tablaDocente_Asig_Proyecto').DataTable({ 
    ...
    "columnDefs":[{
        ...
        <button  type="button" class="btn btn-info btneditar_Proyecto" >
                    <i class="fas fa-edit"></i>
                  </button>

                  <button  type="button" class="btn btn-danger btnBorrar_Docente_asignacion_Proyecto" >
                    <i class="fas fa-times"></i>
                  </button>`,
...
var tablaDocente_Asig_cargo = $('#tablaDocente_Asig_cargo').DataTable({ 
    ...
    "columnDefs":[{
        ...
        <button  type="button" class="btn btn-info btneditar_cargo" >
                    <i class="fas fa-edit"></i>
                  </button>

                  <button  type="button" class="btn btn-danger btnBorrar_Docente_asignacion_cargo" >
                    <i class="fas fa-times"></i>
                  </button>`,
 ...
 var tablaDocente_Asig = $('#tablaDocente_Asig').DataTable({ 
    ...
    "columnDefs":[{
        ...
        "defaultContent": `
                    ...
                    <button  type="button" class="btn btn-info btnEDITAR_Docente_asignacion" >
                    <i class="fas fa-edit"></i>
                  </button>

                  <button  type="button" class="btn btn-danger btnBorrar_Docente_asignacion" >
                    <i class="fas fa-times"></i>
                  </button> `,
