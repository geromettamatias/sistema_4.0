...
<input hidden="" id="cicloLectivo" value="<?php echo $cicloLectivo; ?>">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-success">
              ...
              <div class="card-body">
                ...
                <div id="cargaCicloCuatro"><img  src="../elementos/cargando.gif"  style="width: 150px;"></div>

                <button  class="btn btn-danger glyphicon glyphicon-pencil" onclick="regresarBotonAsig('')">Regresar <i class='fas fa-edit'></i></button>
...
function  eliminarHorarioDiaFinal(idDescrip,dia,horario){
        ...
        $.ajax({
            url: "modulos/cargaDatos/datosCurso/elementos/crud_fechaHorario_Asignatura.php",
            type: "POST",
            dataType: "json",
            beforeSend: function() {
                                $("#imagenProceso").show();
...
console.log({idDescrip:idDescrip, dia:dia,  opcion:opcion, horario:horario, idAsig:idAsig, idCurso:idCurso, nombre:nombre, cursoSeleB:cursoSeleB})
 if (idAsig!='0') {
    $.ajax({
        url: "modulos/cargaDatos/datosCurso/elementos/crud_fechaHorario_Asignatura.php",
        type: "POST",
        ...
        data: {idDescrip:idDescrip, dia:dia,  opcion:opcion, horario:horario, idAsig:idAsig, idCurso:idCurso, nombre:nombre, cursoSeleB:cursoSeleB},
        success: function(data){  
          console.log(data);
            ...
            else{tablaDiaHorario.row(fila).data([idDescrip2,idAsignatura2,nombre,dia2,horario2]).draw();}  $("#imagenProceso").hide();
                                document.getElementById("btn_nuevo_dia_hora").disabled = false;
