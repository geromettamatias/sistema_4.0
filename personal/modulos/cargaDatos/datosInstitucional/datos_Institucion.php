          ...
          <div class="col-md-12">
            ...
            <div class="card card-success">
              ...
              <div class="card-header">
                <h3 class="card-title">Carga de datos Institucional</h3>
            ...
            <?php if ($operacion=='Lectura y Escritura'){ ?>
                ...
                <button id="btnNuevo_Institucional" type="button" class="btn btn-success" data-toggle="modal" title="Nuevo Ciclo Lectivo"><i class='fas fa-edit'></i></button><br> <hr>    
...
<div class="modal fade" id="modalCRUD_Institucion" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    ...
    "columnDefs":[{
        ...
        "defaultContent": `<div class="btn-group" role="group">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                      ...
                                      <li><a title='Modificar tola la fila' class="dropdown-item btnEditar_Institucional" href="javascript:void(0)">Editar</a></li>
                                      <li><a title='Eliminar tola la fila' class="dropdown-item btnBorrar_Institucional" href="javascript:void(0)">Eliminar</a></li>
                                    </ul>
                                  </div>
                                </div>`,  
       }],
...
function  eliminarDefinitivo(idInstitucion,nombre,cue,opcion){
        ...
        $.ajax({
            url: "modulos/cargaDatos/datosInstitucional/elementos/crud_datos_Institucional.php",
            type: "POST",
            dataType: "json",
            data: {opcion:opcion, idInstitucion:idInstitucion},
            beforeSend: function() {
                                $("#imagenProceso").show();
                                document.getElementById("btnNuevo_Institucional").disabled = true;
        ...
        $("#imagenProceso").hide();
                                document.getElementById("btnNuevo_Institucional").disabled = false;
