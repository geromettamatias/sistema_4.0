...
$consulta = "SELECT `id_titulo`, `tituloGenera` FROM `confi_informe_titulo_$cicloLectivo`";
...
<button class="btn btn-warning" title="Configurar Segunda Hoja del Informe" onclick="segundaHoja()"><i class="fas fa-share"></i></button>
...
function eliminar_FINAL(){
    ...
    dataFila.push(opcion);
        ...
        $.ajax({
            url: "modulos/herramientas/conf_informe/elementos/crud_titulos.php",
            type: "POST",
...
function cargarPregunta(id_titulo){
                   ...
                   $.ajax({
            url: "modulos/herramientas/conf_informe/elementos/sessionFinal.php",
            type: "POST",
            ...
            success: function(r){
                ...
                if (r==1) {
                    ...
                    $('#tablaInstitucional').html(''); 
                       $('#tablaInstitucional').load('modulos/herramientas/conf_informe/conf_informe.php');
                      $('#contenidoAyuda').html(''); 
