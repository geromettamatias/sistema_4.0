...
<div id="tablaInstitucionalFinal"></div>
...
$('#imagenProceso').show();
 ...
 $.blockUI({ 
     ...
     $.ajax({
          ...
          url:'modulos/herramientas/usuarios/elementos/seccionCursosPPP.php',
          success:function(r){

               $('#tablaInstitucionalFinal').html('');
        $('#contenidoAyuda').html(''); 
        $('#imagenProceso').hide(); 
            $('#tablaInstitucionalFinal').load('modulos/herramientas/usuarios/usuarioOtroDos.php');
