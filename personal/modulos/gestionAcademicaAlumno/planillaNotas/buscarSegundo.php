...
<script type="text/javascript">
  $("#cursoSe").change(function(){
    ...
    $.ajax({
          ...
          url:'modulos/gestionAcademicaAlumno/planillaNotas/elementos/seccionCursosLOO.php',
          success:function(r){
            ...
            $('#contenidoAyuda').load('modulos/gestionAcademicaAlumno/planillaNotas/buscarTerero.php');
