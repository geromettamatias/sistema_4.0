          ...
          <div class="col-md-12">
            ...
            <div class="card card-danger">
              ...
              <div class="card-header">
                <h3 class="card-title">PLANILLA CENTRALIZADORA DE TODAS LAS COLUMNAS</h3>

                <div class="card-tools">
                  <button type="button" class="btn btn-tool" data-card-widget="collapse">
                    <i class="fas fa-minus"></i>
                  </button>
                  <button onclick="remover43344()" type="button" class="btn btn-tool" data-card-widget="remove">
              ...
              <div class="card-body">
                ...
                <button  type="button" class="btn btn-success modalCRUD_Centralizadora2" data-toggle="modal" title="Nuevo Ciclo Lectivo"><i class="fas fa-print"></i></button><br> <hr>    
...
e.preventDefault(); 
   ...
   window.open('modulos/gestionAcademicaAlumno/centralizadora/tablaImprimir.php', '_blank'); 
