        ...
        <table  class="customers"  style="width:100%" >
                        <thead class="letras">
                            <tr>
                                ...
                                <th rowspan="2"><span style='writing-mode: vertical-rl;transform: rotate(180deg); font-size: 13px; padding: 10px; margin: 10px'><?php  echo $asig;?></span></th>
...
<span class="letras" style='font-size: 10px; vertical-align:middle;'>LA CALIFICACIÓN CORRESPONDIENTE A PENDIENTE DE APROBACIÓN SE CONSIGNARÁ CUANDO SEA APROBADA. ENMIENDAS Y RASPADURAS, PARA SER VÁLIDAS DEBEN CONTAR EN OBSERVACIONES CON LA FIRMA DEL DIRECTOR</span>
